...
<link rel="stylesheet" href="css/editFirm/editFirmForm2.css?v=<?php echo filemtime("css/editFirm/editFirmForm2.css") ?>">
                    ...
                    <?php
                        ...
                        ?>
                            <tr id="<?php echo $row['id']; ?>" class="rownum<?php echo $row['id']; ?>">
                                ...
                                <td class="name click" id="name_<?php echo $row['id']; ?>" title="<?php echo $row["name"]; ?>"><?php echo $row["name"]; ?></td>
                                <td class="surname click" title="<?php echo $row["surname"]; ?>"><?php echo $row["surname"]; ?></td>
                                <td class="email click" id="e_<?php echo $row['id']; ?>" title="<?php echo $row["email"]; ?>"><?php echo $row["email"]; ?></td>
                                ...
                                <td class="date_of_contact hidec click" title="<?php echo $row["date_of_contact"]; ?>"><?php echo $row["date_of_contact"]; ?></td>
